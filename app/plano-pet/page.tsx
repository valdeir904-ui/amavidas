  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      <main className="flex-1 pt-20">
        ...
        {/* ── HERO SECTION ── */}
        <section className="pt-4 pb-12 min-[768px]:pt-6 min-[768px]:pb-16 bg-gradient-to-b from-[#EFF6FF] via-[#F5F3FF] to-[#F8FAFC] overflow-hidden">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                  ...
                  <button
                    ...
                    className="bg-purple-700 hover:bg-purple-800 text-white font-bold px-6 py-4 rounded-2xl text-base transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
                  >
