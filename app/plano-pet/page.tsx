  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      <main className="flex-1 pt-24">
        ...
        {/* ── HERO SECTION ── */}
        <section className="py-16 min-[768px]:py-24 bg-gradient-to-b from-[#EFF6FF] via-[#F5F3FF] to-[#F8FAFC] overflow-hidden">
          <div className="max-w-[1280px] mx-auto px-5 min-[640px]:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <motion.div 
                ...
                variants={fadeUp}
              >
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-100 border border-purple-200 text-purple-900 text-xs font-bold uppercase tracking-wider mb-6 shadow-sm">
                  <span>🐾</span> Plano Pet AmaVidas · Apenas R$ 25/mês
                </div>

                <h1 
                  className="text-4xl min-[768px]:text-5xl lg:text-6xl font-medium tracking-tight text-slate-900 leading-[1.12] mb-6"
                ...
                <p className="text-slate-600 text-lg min-[768px]:text-xl leading-relaxed mb-8 max-w-2xl">
                ...
                {/* Bullet List */}
                <div className="space-y-3 mb-8 text-slate-700 text-base font-medium">
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full bg-purple-100 text-purple-700 flex items-center justify-center font-bold text-xs">✓</div>
                    <span>Cobre 1 cão ou gato (<strong>sem limite de peso ou porte</strong>)</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full bg-purple-100 text-purple-700 flex items-center justify-center font-bold text-xs">✓</div>
                    <span>Deslocamento até o memorial + Sala de velório exclusiva</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full bg-purple-100 text-purple-700 flex items-center justify-center font-bold text-xs">✓</div>
                    <span>Embalagem ecológica + Lápide memorial personalizada</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                  <button
                    ...
                    className="bg-purple-700 hover:bg-purple-800 text-white font-bold px-8 py-4 rounded-2xl text-base transition-all shadow-xl hover:shadow-purple-200 hover:-translate-y-0.5 flex items-center justify-center gap-2 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-6 py-4 rounded-2xl text-base transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
                  >
