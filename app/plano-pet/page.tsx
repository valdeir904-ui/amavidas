  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      <main className="flex-1 -mt-[66px] max-[980px]:-mt-[56px] relative">
        ...
        {/* ── HERO SECTION ── */}
        <section className="pt-[110px] min-[768px]:pt-[130px] pb-16 min-[768px]:pb-24 bg-gradient-to-b from-purple-950/40 via-purple-100/20 to-[#F8FAFC] relative overflow-hidden">
